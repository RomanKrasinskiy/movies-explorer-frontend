    ...
    const toggleButton = () => {
        ...
        return (
            <div className='burger'>
                <button className={`burger__button ${isScrollUp ? 'scroll-up' : ''} ${isOpened ? 'open' : ''}`} onClick={toggleButton}>
                    <span></span>
                    <span></span>
                    <span></span>
                </button>
                <div className={`burger__container ${isOpened ? 'show' : ''}`}>
                    ...
                    <NavLink className="burger__link_type_profile" to='/profile'>
                        <div className='icon-profile'>
                            <p className='burger__link icon-profile_text' to='/profile'>Аккаунт</p>
